	...
	<div id="app" class="wrapper">
		<nav id="sidebar" class="sidebar">
			<div class="sidebar-content js-simplebar">
				<router-link class="sidebar-brand" to="/operator/maintenance/dashboard">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						<router-link class="sidebar-link" to="/operator/maintenance/dashboard">
					...
					<li class="sidebar-item">
						<a data-target="#jobcard" data-toggle="collapse" class="sidebar-link collapsed">
							<i class="align-middle" data-feather="layers"></i> <span class="align-middle">Job Card</span>
						</a>
						<ul id="jobcard" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
							<li class="sidebar-item"><router-link class="sidebar-link" to="/operator/maintenance/mcscr">Corretiva</router-link></li>

							<li class="sidebar-item"><router-link class="sidebar-link" to="/operator/maintenance/taskmcscr">Preventiva</router-link></li>

							<li class="sidebar-item"><router-link class="sidebar-link" to="/operator/maintenance/inspections">Inspeção</router-link></li>
						</ul>
					</li>

					<li class="sidebar-item">
						<a data-target="#tools" data-toggle="collapse" class="sidebar-link collapsed">
							<i class="align-middle" data-feather="layers"></i> <span class="align-middle">Ferramentaria</span>
						</a>
						<ul id="tools" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
							<li class="sidebar-item"><router-link class="sidebar-link" to="/operator/maintenance/toolshops">Ferramentas</router-link></li>
							{{-- <li class="sidebar-item"><router-link class="sidebar-link" to="/operator/maintenance/toolrequests">Requisições</router-link></li>				 --}}
						</ul>
					</li>

					<li class="sidebar-item">
						<a data-target="#stock" data-toggle="collapse" class="sidebar-link collapsed">
							<i class="align-middle" data-feather="layers"></i> <span class="align-middle">Stock</span>
						</a>
						<ul id="stock" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
							{{-- <li class="sidebar-item"><router-link class="sidebar-link" to="/operator/maintenance/stockcenters">Centro de Stock</router-link></li>
							<li class="sidebar-item"><router-link class="sidebar-link" to="/operator/maintenance/brands">Marca</router-link></li>
							<li class="sidebar-item"><router-link class="sidebar-link" to="/operator/maintenance/categories">Categoria</router-link></li>
							<li class="sidebar-item"><router-link class="sidebar-link" to="/operator/maintenance/stocksuppliers">Fornecedor Stock</router-link></li> --}}
							<li class="sidebar-item"><router-link class="sidebar-link" to="/operator/maintenance/products">Produto</router-link></li>
							{{-- <li class="sidebar-item"><router-link class="sidebar-link" to="/operator/maintenance/inventories">Inventário</router-link></li>
							<li class="sidebar-item"><router-link class="sidebar-link" to="/operator/maintenance/entrynotes">Nota de Entrada</router-link></li>
							<li class="sidebar-item"><router-link class="sidebar-link" to="/operator/maintenance/exitnotes">Nota de Saída</router-link></li>
							<li class="sidebar-item"><router-link class="sidebar-link" to="/operator/maintenance/stocktransfers">Transferência</router-link></li>				
							<li class="sidebar-item"><router-link class="sidebar-link" to="/operator/maintenance/stockrequests">Requisições</router-link></li>				 --}}
					...
					<li class="sidebar-item">
						<router-link class="sidebar-link" to="/operator/maintenance/profile" >
				...
				<ul class="navbar-nav d-none d-lg-flex">
						...
						<div class="dropdown-menu dropdown-menu-start dropdown-mega" aria-labelledby="megaDropdown">
							<div class="d-md-flex align-items-start justify-content-start">
								...
								<div class="dropdown-mega-list">
									...
									<router-link to="/operator/maintenance/dashboard" class="dropdown-item" >Painel de Análise</router-link>
									<router-link to="/operator/maintenance/dashboard" class="dropdown-item" >Perfil</router-link>
									<router-link to="/operator/maintenance/dashboard" class="dropdown-item" >Organização</router-link>
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
							<router-link class="dropdown-item" to="/operator/maintenance/dashboard"><i class="align-middle me-1" data-feather="home"></i>
								Dashboard</router-link>
							<router-link class="dropdown-item" to="/operator/maintenance/dashboard"><i class="align-middle me-1" data-feather="book-open"></i>
								Documentação</router-link>
							<router-link class="dropdown-item" to="/operator/maintenance/dashboard"><i class="align-middle me-1"
					...
					<div class="row text-muted">
						...
						<div class="col-6 text-right">
							<ul class="list-inline">
								...
								<li class="list-inline-item">
									<router-link to="/operator/maintenance/dashboard" class="text-muted" href="#">Ajuda</router-link>
								</li>
								{{-- <li class="list-inline-item">
									<a class="text-muted" href="#">Privacy</a>
								</li> --}}
								<li class="list-inline-item">
									<router-link to="/operator/maintenance/dashboard" class="text-muted" href="#">Termos e Privacidade</router-link>
								</li>
							</ul>
						</div>
					</div>
