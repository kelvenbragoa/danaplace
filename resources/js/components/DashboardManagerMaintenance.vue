...
<template>
    ...
    <div v-if="!loadingDiv">
        <h1 class="h3 mb-3">Dashboard Gestor Manutenção</h1>
                                            ...
                                            <div class="col-sm-6 col-xl-3">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mb-0">
                                                             <router-link to="/manager/maintenance/areas"><vue-feather type="eye"></vue-feather></router-link>
                                                        </div>
                                            ...
                                            <div class="col-sm-6 col-xl-3">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mb-0">
                                                             <router-link to="/manager/maintenance/destinations"><vue-feather type="eye"></vue-feather></router-link>
                                                        </div>
                                            ...
                                            <div class="col-sm-6 col-xl-3">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mb-0">
                                                             <router-link to="/manager/maintenance/type_equipments"><vue-feather type="eye"></vue-feather></router-link>
                                                        </div>
                                            ...
                                            <div class="col-sm-6 col-xl-3">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mb-0">
                                                             <router-link to="/manager/maintenance/malfunctions"><vue-feather type="eye"></vue-feather></router-link>
                                                        </div>
                                            ...
                                            <div class="col-sm-6 col-xl-3">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mb-0">
                                                             <router-link to="/manager/maintenance/suppliers"><vue-feather type="eye"></vue-feather></router-link>
                                                        </div>
                                            ...
                                            <div class="col-sm-6 col-xl-3">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mb-0">
                                                             <router-link to="/manager/maintenance/tasks"><vue-feather type="eye"></vue-feather></router-link>
                                                        </div>
