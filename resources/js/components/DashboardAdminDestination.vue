<script setup>
import { ref, onMounted,onUpdated, reactive, defineEmits, defineComponent,watch } from "vue";
...
const getDashboardData = () => {
    axios
        .get("/admins/destination/dashboard/getdashboarddata")
        .then((response) => {
            users.value = response.data.users;
            areas.value = response.data.areas;
            retrievedData.value = response.data.actualfleet;
            fleet.value = response.data.actualfleet;
            ...
            equipmentscount.value = response.data.equipmentscount;
            mcscr.value = response.data.mcscrcount;

            actualid.value = response.data.actualfleet.id;
...
const getFleetData = (id)=>{

    console.log(id)
    axios.get(`/updatedashboard/${id}`)
    .then((response)=>{
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col">
                                <img src="/files/img/sys/companylogo.png" class="img-fluid" alt="M+D" width="150" height="150">
                            </div>
                            <!-- <div class="col text-right">
                                <img src="/files/img/sys/volvopenta1.png" class="img-fluid" alt="M+D" width="150" height="150">
                            </div> -->
                        </div>
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-2">
                                <label class="form-label" for="province_id"
                                    >Escolher Frota</label
                                >
                                <select
                                    class="form-control"
                                    v-model="actualid"
                                    @change="getFleetData(actualid)"
                                    name="fleetid"
                                >
                                    <option
                                        v-for="(typeequipment,index) in typeequipments"
                                        :key="typeequipment.id"
                                        :value="typeequipment[0].type_equipment.id"
                                    >
                                        {{ index }}
                                    </option>
                                </select>
                                                  ...
                                                  <div class="w-100">
                                                           ...
                                                           <div class="col-sm-6 col-xl-2">
                                                              <div class="card">
                                                                  <div class="card-body">
                                                                      <div class="row">
                                                                          <div class="col mt-0">
                                                                              <h5 class="card-title">JobCard</h5>
                                                          ...
                                                          <div class="col-12 col-lg-6">
                                                              <div class="card">
                                                                  <div class="card-header">
                                                                      ...
                                                                      <!-- <h6 class="card-subtitle text-muted">JobCard e Atividades Planeadas por mês durante corrente ano.</h6> -->
                                                                  </div>
                                                                  <div class="card-body">
                                                                      <div class="chart">
                                                                          <Bar
                                                      ...
                                                      <div class="row">
                                                          ...
                                                          <div class="col-6 col-lg-6">
                                                                  <div class="card">
                                                                      <div class="card-header">
                                                                          <h5 class="card-title">Tempo de Duração dos Estados do JobCard (em minutos)</h5>
                                                          ...
                                                          <div class="col-12 col-lg-6">
                                                              <div class="card">
                                                                  <div class="card-header">
                                                                      ...
                                                                      <!-- <h6 class="card-subtitle text-muted">Custo de Material para JobCard e Atividades Planeadas por mês durante corrente ano.</h6> -->
                                                                  </div>
                                                                  <div class="card-body">
                                                                      <div class="chart">
                                                                          <Bar
                                                          ...
                                                          <table class="table table-striped">
                                                              <thead>
                                                                  <tr>
                                                                      ...
                                                                      <th>Área</th>
                                                                      <th>Destino</th>
                                                                      <th>Estado Último JobCard(Corretiva)</th>
                                                                      <th>Nº JobCard Mês(Corretiva)</th>
                                                                  ...
                                                                  <tr  v-for="(actualData,index) in equipments.data" :key="actualData.id">
                                                                      ...
                                                                      <td >
                                                                          <span v-if="actualData.lastmcscr !=null">
                                                                              ...
                                                                              <p>Motivo:{{ actualData.lastmcscr.reason_id == null ? actualData.lastmcscr.reason : actualData.lastmcscr.reason_name.name}}</p>
                                                                          </span>
                                                                          <span v-else>
                                                                              -----
                                                                          </span>
                                                                      ...
                                                                      <td>
                                                                          ...
                                                                          <router-link :to="'/admin/destination/equipments/'+actualData.id"><vue-feather type="eye"></vue-feather></router-link> 
