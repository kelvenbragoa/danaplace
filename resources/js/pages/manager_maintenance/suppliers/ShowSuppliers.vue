...
const getData = (page=1) => {
  axios.get(`/suppliers/+${router.currentRoute.value.params.id}?page=${page}`,
      {
        params:{
       ...
       .then((response)=>{
        ...
        retrievedData.value = response.data.supplier;
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-xxl-12 d-flex">
                                                <div class="w-100">
                                                    <p>Nome da Fabricantes/Fornecedores: {{ retrievedData.name }}</p>
