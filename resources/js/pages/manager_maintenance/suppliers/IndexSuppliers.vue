...
<template>
    <div v-if="!loadingDiv">
        <h1 class="h3 mb-3">Fabricantes/Fornecedores</h1>
        
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Tabela dos fabricantes/fornecedores do sistema. {{ retriviedData.total }} registros encontrados.</h5>
                                        <h6 class="card-subtitle text-muted">Para procurar, digite na caixa de procura</h6>

                                        <router-link to="/manager/maintenance/suppliers/create" class="btn btn-pill btn-primary mt-3"><vue-feather type="plus"></vue-feather>Adicionar</router-link> 
                                                    ...
                                                    <tr  v-for="(actualData,index) in retriviedData.data" :key="actualData.id">
                                                        ...
                                                        <td>
                                                            {{ 
                                                                ...
                                                                Math.round(
                                                                    (100 * actualData.available_equipments.length) / (actualData.available_equipments.length + actualData.unavailable_equipments.length))
                                                                    : 0
                                                            }}%
                                                        </td>
                                                        ...
                                                        <td>
                                                            <router-link :to="'/manager/maintenance/suppliers/'+actualData.id+'/edit'"><vue-feather type="edit-2"></vue-feather></router-link>
                                                            <router-link :to="'/manager/maintenance/suppliers/'+actualData.id"><vue-feather type="eye"></vue-feather></router-link> 
