...
const getData = (page=1) => {
  axios.get(`/fleets/+${router.currentRoute.value.params.id}?page=${page}`)
       .then((response)=>{
        ...
        chartData.value.datasets[0].data = response.data.dataChartAvailable;
        chartData.value.datasets[1].data = response.data.dataChartUnAvailable;
        ...
        chartData7.value.datasets[0].data = response.data.dataChartTaskMcscrDone;
        chartData7.value.datasets[1].data = response.data.dataChartTaskMcscrScheduled;
       }).catch(()=>{
        loadingDiv.value=false;
       })
}
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <router-link :to="'/manager/maintenance/type_equipments/'+retrievedData.id" class="btn btn-pill btn-primary mt-3"><vue-feather type="arrow-left"></vue-feather>Voltar</router-link> 
                                                ...
                                                <div class="w-100">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 col-lg-12">
                                                            <div class="card">
                                                                <div class="card-header">
                                                                    <h5 class="card-title">Atividades Planeadas Realizado x Programado</h5>
                                                                    <h6 class="card-subtitle text-muted">Atividades Planeadas Realizado x Programado por mês durante corrente ano.</h6>
                                                                </div>
                                                                <div class="card-body">
                                                                    <div class="chart">
                                                                        <Bar
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-lg-6">
                                                            <div class="card">
                                                                <div class="card-header">
                                                                    <h5 class="card-title">Custo Mão de Obra por mês para MCSCR e Atividades</h5>
                                                        ...
                                                        <div class="col-12 col-lg-6">
                                                            <div class="card">
                                                                <div class="card-header">
                                                                    <h5 class="card-title">Custo de Material para MCSCR e Atividades</h5>
...
<div class="col-12 col-lg-6">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">Consumo de Combustivel da Frota</h5>
                                                        ...
                                                        <table class="table table-striped">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>Área</th>
                                                                    <th>Destino</th>
                                                                    <th>Estado Último MCSCR</th>
                                                                    <th>Nº MCSCR Mês</th>
                                                                    <th>Nº Atividades Mês</th>
                                                                    <th>Estado</th>
                                                                    <th>Operação</th>
                                                                    <th>Ações</th>
                                                                </tr>
