                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <router-link to="/manager/maintenance/type_equipments" class="btn btn-pill btn-primary mt-3"><vue-feather type="arrow-left"></vue-feather>Voltar</router-link> 
                                        <router-link :to="'/manager/maintenance/fleet/'+retrievedData.id" class="btn btn-pill btn-primary mt-3"><vue-feather type="truck"> </vue-feather>Frota</router-link> 
                                                        ...
                                                        <table class="table table-striped">
                                                            ...
                                                            <tbody v-if="components.data.length > 0">
                                                                <tr v-for="(actualData,index) in components.data" :key="actualData.id">
                                                                    ...
                                                                    <td>
                                                                        <router-link :to="'/manager/maintenance/type_equipments/component/'+actualData.id+'/edit'"><vue-feather type="edit-2"></vue-feather></router-link>
                                                                        <router-link :to="'/manager/maintenance/type_equipments/component/'+actualData.id"><vue-feather type="eye"></vue-feather></router-link> 
