                                                    ...
                                                    <Form @submit="editFunction" :validation-schema="schema" v-slot="{ errors }">
                                                        ...
                                                        <div class="row">
                                                            <div class="mb-3 col-md-12">
                                                                ...
                                                                <Field as="select" class="form-control" :class="{'is-invalid':errors.equipment_component_id}" v-model="retrievedData.equipment_component_id" name="equipment_component_id" id="equipment_component_id" aria-describedby="equipment_component_id">
                                                                    <option value="" disabled selected>Selecionar</option>
