...
const getData = () => {
  axios.get(`/solutions/+${router.currentRoute.value.params.id}`)
       .then((response)=>{
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Solução: {{ retrievedData.name }}</h5>

                                        <router-link to="/manager/maintenance/solutions" class="btn btn-pill btn-primary mt-3"><vue-feather type="arrow-left"></vue-feather>Voltar</router-link> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-xxl-12 d-flex">
                                                <div class="w-100">
                                                    <p>Solução: {{ retrievedData.name }}</p>
