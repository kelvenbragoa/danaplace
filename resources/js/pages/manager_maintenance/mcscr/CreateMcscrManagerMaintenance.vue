...
const createRecordFunction = (values, actions) => {
    ...
    actions.resetForm();
    router.push({ path: '/manager/maintenance/mcscr' });
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <router-link to="/manager/maintenance/mcscr" class="btn btn-pill btn-primary mt-3"><vue-feather type="arrow-left"></vue-feather>Voltar</router-link> 
