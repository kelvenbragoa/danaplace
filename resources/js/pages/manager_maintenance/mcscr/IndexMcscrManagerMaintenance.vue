...
const mcscrStatus = {'terminado':1,'aguardaaprovacao':2,'emexecucao':3,'pendente':4,'emdiagnostico':5}
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <router-link to="/manager/maintenance/mcscr/create" class="btn btn-pill btn-primary mt-3"><vue-feather type="plus"></vue-feather>Adicionar</router-link> 
