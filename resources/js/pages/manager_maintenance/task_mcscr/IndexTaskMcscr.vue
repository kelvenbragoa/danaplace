...
<template>
    <div v-if="!loadingDiv">
        <h1 class="h3 mb-3">Atividades Agendadas</h1>

                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Tabela dos Atividades Agendadas do sistema. {{ retriviedData.total }} registros encontrados.</h5>
                                        <h6 class="card-subtitle text-muted">Para procurar, digite na caixa de procura</h6>

                                        <router-link to="/manager/maintenance/taskmcscr/create" class="btn btn-pill btn-primary mt-3"><vue-feather type="plus"></vue-feather>Adicionar</router-link> 
                                                ...
                                                <tbody v-if="retriviedData.data.length > 0">
                                                    <tr  v-for="(actualData,index) in retriviedData.data" :key="actualData.id">
                                                        ...
                                                        <td>
                                                            ...
                                                            <span v-if="actualData.task_mcscr_status_id == 2" class="badge bg-danger">
                                                                {{ actualData.task_mcscr_status.name}}
                                                            </span>
                                                            <span v-if="actualData.task_mcscr_status_id == 3" class="badge bg-success">
                                                                {{ actualData.task_mcscr_status.name}}
                                                            </span>
                                                        ...
                                                        <td>
                                                            <router-link :to="'/manager/maintenance/taskmcscr/'+actualData.id+'/edit'" v-if="actualData.task_mcscr_status_id != 2"><vue-feather type="edit-2"></vue-feather></router-link>
                                                            <router-link :to="'/manager/maintenance/taskmcscr/'+actualData.id"><vue-feather type="eye"></vue-feather></router-link> 
