...
const getData = (page=1) => {
  axios.get(`/equipments/+${router.currentRoute.value.params.id}?page=${page}`,
       ...
       .then((response)=>{
        ...
        chartData9.value.datasets[0].data = response.data.dataChartTaskMcscrDone;
        chartData9.value.datasets[1].data = response.data.dataChartTaskMcscrScheduled;
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <router-link to="/manager/maintenance/equipments" class="btn btn-pill btn-primary mt-3"><vue-feather type="arrow-left"></vue-feather>Voltar</router-link> 
...
<!--                                                                     
                                                                    <td>
                                                                        <router-link :to="'/manager/maintenance/equipments/component/'+actualData.id+'/edit'"><vue-feather type="edit-2"></vue-feather></router-link>
                                                                        <router-link :to="'/manager/maintenance/equipments/component/'+actualData.id"><vue-feather type="eye"></vue-feather></router-link> 
