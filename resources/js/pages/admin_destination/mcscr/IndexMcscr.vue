...
let dataIdBeingDeleted = ref(null);
 ...
 const getData = async (page = 1,status) => {
  ...
  axios.get(`/destination-mcscr?page=${page}`,
      {
        params:{
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <!-- <router-link to="/admin/mcscr/create" class="btn btn-pill btn-primary mt-3"><vue-feather type="plus"></vue-feather>Adicionar</router-link>  -->
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody v-if="retriviedData.data.length > 0">
                                                    <tr  v-for="(actualData,index) in retriviedData.data" :key="actualData.id">
                                                        ...
                                                        <td>
                                                            <!-- <router-link :to="'/admin/mcscr/'+actualData.id+'/edit'" v-if="actualData.mcscr_status_id != 1"><vue-feather type="edit-2"></vue-feather></router-link> -->
                                                            <!-- <router-link :to="'/admin/mcscr/'+actualData.id+'/edit'" ><vue-feather type="edit-2"></vue-feather></router-link> -->
                                                            <router-link :to="'/admin/destination/mcscr/'+actualData.id"><vue-feather type="eye"></vue-feather></router-link> 
