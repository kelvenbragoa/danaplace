...
const getData = () => {
  axios.get(`/destination-taskmcscr/+${router.currentRoute.value.params.id}`)
       .then((response)=>{
						...
						<div class="col-12">
							<div class="card">
								<div class="card-body m-sm-3 m-md-5 border">
                                    ...
                                    <div class="mb-4">
                                        <router-link to="/admin/destination/taskmcscr" class="btn btn-pill btn-primary mt-3"><vue-feather type="arrow-left"></vue-feather>Voltar</router-link>
                                    </div> 
                                    <div id="print-me">
                                    <div class="row mb-4">
                                        <div class="row">
                                    ...
                                    <div class="row mb-4">
										<div class="col">
											...
											<p> 
                                                {{ retrievedData.area.company_name ?? 'N/A' }} 
                                                <br> 
