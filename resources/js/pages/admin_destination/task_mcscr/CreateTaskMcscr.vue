...
const createRecordFunction = (values, actions) => {
    ...
    actions.resetForm();
    router.push({ path: '/admin/taskmcscr' });
                                                            ...
                                                            <FieldArray class="form-control" name="subtasks">
                                                                <fieldset class="InputGroup" v-for="(subtask, idx) in subtasks" :key="subtask.key">
                                                                    <div class="mb-3 col-md-12">
                                                                        ...
                                                                        <Field as="select" :name="`subtasks[${idx}].name`" class="form-control" v-if="subtask.type_sub_task_id==1" value="1">
                                                                            <option value="1">Sim</option>
                                                                            <option value="0" >Não</option>

                                                                        </Field> 

                                                                        <Field as="select" :name="`subtasks[${idx}].name`" class="form-control" v-if="subtask.type_sub_task_id==2" value="2">
                                                                            <option value="2">Excelente</option>
                                                                            <option value="1">Bom</option>
                                                                            <option value="0">Mau</option>
                                                                        </Field>  

                                                                        <Field type="text" class="form-control" :name="`subtasks[${idx}].name`" v-if="subtask.type_sub_task_id==3" value="N/A"/>
                                                                    ...
                                                                    <tbody>
                                                                        <FieldArray class="form-control" name="materials">
                                                                            <tr v-for="(material, idx) in materials" :key="material.key">
                                                                                ...
                                                                                <td>
                                                                                    <fieldset>
                                                                                        <Field type="number" class="form-control" :name="`materials[${idx}].quantity`" :id="`materials[${idx}].quantity`" placeholder="Quantidade a Requisitar" value="0" required/>
                                                                    ...
                                                                    <tbody>
                                                                        <FieldArray class="form-control" name="departments">
                                                                            <tr v-for="(department, idx) in departments" :key="department.key">
                                                                                ...
                                                                                <td>
                                                                                    <fieldset>
                                                                                        <Field type="number" class="form-control" :name="`departments[${idx}].quantity`" :id="`departments[${idx}].quantity`" placeholder="Quantidade a Requisitar" value="0" required/>
