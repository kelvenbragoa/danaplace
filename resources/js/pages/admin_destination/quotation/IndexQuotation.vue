...
let dataIdBeingDeleted = ref(null);
 ...
 const getData = async (page = 1) => {
  axios.get(`/destination-quotation?page=${page}`,
      {
        params:{
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <router-link to="/admin/destination/quotation/create" class="btn btn-pill btn-primary mt-3"><vue-feather type="plus"></vue-feather>Adicionar</router-link> 
                                                ...
                                                <tbody v-if="retriviedData.data.length > 0">
                                                    <tr  v-for="(actualData,index) in retriviedData.data" :key="actualData.id">
                                                        ...
                                                        <td>
                                                            ...
                                                            <span v-if="actualData.status_quotation_id == 2" class="badge bg-danger">
                                                                {{ actualData.status.name}}
                                                            </span>
                                                            <span v-if="actualData.status_quotation_id == 3" class="badge bg-success">
                                                                {{ actualData.status.name}}
                                                            </span>
                                                        ...
                                                        <td>
                                                            ...
                                                            <router-link :to="'/admin/destination/quotation/'+actualData.id"><vue-feather type="eye"></vue-feather></router-link> 
