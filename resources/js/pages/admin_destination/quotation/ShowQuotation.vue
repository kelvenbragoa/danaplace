...
const getData = (page=1) => {
  axios.get(`/destination-quotation/+${router.currentRoute.value.params.id}`,
      {
        params:{
                                        ...
                                        <div class="card-body m-sm-3 m-md-5 border">
                                            <div id="print-me">
                                                ...
                                                <div class="row ">
                                                    <div
                                                        ...
                                                        style="text-align: left"
                                                    >
                                                        <strong> Condominio Areia Branca Lda </strong>
                                                        <p> Av. Samora Machel 372F
                                                            <br />
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <p>Cliente: <strong>{{ retrievedData.destination_id != 0 ? retrievedData.destination.company_name : retrievedData.company_name }}</strong> 
                                                        <br> 
                                                ...
                                                <div class="col text-right">
                                                    ...
                                                    <p>Cotação Data: <strong>{{ moment(retrievedData.created_at).format('DD/MM/YYYY') }}</strong> 
                                                        <br> 
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody v-if="retrievedData.itens.length > 0">
                                                    <tr  v-for="(actualData,index) in retrievedData.itens" :key="actualData.id">
                                                        ...
                                                        <td>#{{ actualData.quotation_id}}</td>
                                                        <td>{{ actualData.product_name}}</td>
                                                        <td>{{ actualData.quantity}}</td>
                                                        <td>{{ actualData.unit_price}} {{ retrievedData.coin.name}}</td>
                                                        <td>{{ actualData.discount}} {{ retrievedData.coin.name}}</td>
                                                        <td>{{ actualData.total -  actualData.discount ?? 0}} {{ retrievedData.coin.name}}</td>
                                                    </tr>
                                                </tbody>
                                                <tbody v-else>
                                                    <tr>
                                            ...
                                            <p class="text-right">
                                                <strong>SUBTOTAL</strong>:{{ retrievedData.total_amount - retrievedData.total_discount }} {{ retrievedData.coin.name}}
                                            </p>
                                            <p class="text-right">
                                                <strong>IVA 16%</strong>:{{ (retrievedData.total_amount - retrievedData.total_discount) * 0.16 }} {{ retrievedData.coin.name}}
                                            </p>
                                            <p class="text-right">
                                                <strong>TOTAL</strong>:{{ (retrievedData.total_amount - retrievedData.total_discount) + (retrievedData.total_amount - retrievedData.total_discount) * 0.16}} {{ retrievedData.coin.name}}
                                            </p>
                                            ...
                                            <p>
                                               <strong>Detalhes bancários:</strong>  <br>
                                                    Nome da conta: Condominio Areia Branca Limitada NUIT: 400634319 <br> <br>
