...
const editFunction = (values, actions) => {
  ...
  axios.patch(`/mcscr/${retrievedData.value.id}`,values).then((response)=>{
    ...
    actions.resetForm();
    router.push({ path: '/operator/maintenance/mcscr' });
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <router-link to="/operator/maintenance/mcscr" class="btn btn-pill btn-primary mt-3"><vue-feather type="arrow-left"></vue-feather>Voltar</router-link> 
                                        <router-link :to='"/operator/maintenance/mcscr/"+retrievedData.id+"/upload"' class="btn btn-pill btn-primary mt-3 ml-2"><vue-feather type="file"></vue-feather>Ficheiros</router-link> 
