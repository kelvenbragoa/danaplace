...
const getData = async (page = 1) => {
  axios.get(`/documents/+${router.currentRoute.value.params.id}?page=${page}`, 
  {
        params:{
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-xxl-12 d-flex">
                                                <div class="w-100">
                                                    ...
                                                    <p>Holder: {{ retrievedData.holder }}</p>
                                                    <p>Tipo de Documento: {{ retrievedData.typedocument.name }}</p>
                                                    <p>Descrição: {{ retrievedData.description }}</p>
                                                    <p>Emissão: {{ moment(retrievedData.emission_date).format('DD-MM-YYYY') }}</p>
                                                    <p>Expira: {{ moment(retrievedData.expires_date).format('DD-MM-YYYY') }}</p>
