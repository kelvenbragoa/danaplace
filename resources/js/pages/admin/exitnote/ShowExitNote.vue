...
const getData = (page=1) => {
  axios.get(`/exitnotes/+${router.currentRoute.value.params.id}?page=${page}`,
      {
        params:{
       ...
       .then((response)=>{
        ...
        retrievedData.value = response.data.exitnote;
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Nota de Saída: {{ retrievedData.ref }}</h5>
                                                        ...
                                                        <table class="table table-striped">
                                                            ...
                                                            <tbody v-if="retrievedData.itens.length > 0">
                                                                <tr  v-for="(actualData,index) in retrievedData.itens" :key="actualData.id">
                                                                    ...
                                                                    <td>{{  actualData.last_quantity - actualData.quantity }}</td>
