...
let dataIdBeingDeleted = ref(null);
 ...
 const getData = async (page = 1) => {
  axios.get(`/type_equipments?page=${page}`,
      {
        params:{
...
axios.delete(`/type_equipments/${dataIdBeingDeleted}`)
.then(()=>{
...
axios.get(`/type_equipments/${dataIdBeingCopied}/copy`)
.then((response)=>{
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>Nome do Tipo de Equipamentos</th>
                                                        <th>Componentes</th>
                                                ...
                                                <tbody v-if="retriviedData.data.length > 0">
                                                    <tr  v-for="(actualData,index) in retriviedData.data" :key="actualData.id">
                                                        ...
                                                        <td>
                                                            ...
                                                            <router-link :to="'/admin/type_equipments/'+actualData.id"><vue-feather type="eye"></vue-feather></router-link> 
