...
let dataIdBeingDeleted = ref(null);
 ...
 const getData = async (page = 1) => {
  axios.get(`/shiftequipmentrequest?page=${page}`,
      {
        params:{
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Tabela das Requisições Equipamentos do sistema. {{ retriviedData.total }} registros encontrados.</h5>
                                        <h6 class="card-subtitle text-muted">Para procurar, digite na caixa de procura</h6>

                                        <!-- <router-link to="/admin/shiftequipmentrequest/create" class="btn btn-pill btn-primary mt-3"><vue-feather type="plus"></vue-feather>Adicionar</router-link>  -->
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody v-if="retriviedData.data.length > 0">
                                                    <tr  v-for="(actualData,index) in retriviedData.data" :key="actualData.id">
                                                        ...
                                                        <td>{{ actualData.createdbyuser.firstName +' ' +actualData.createdbyuser.lastName}} ({{ moment(actualData.created_at).format('DD-MM-YYYY H:mm') }})</td>
                                                        <td>{{ actualData.answeredbyuser == null ? '-----' : actualData.answeredbyuser.firstName+' '+actualData.answeredbyuser.lastName +'('+moment(actualData.answered_date).format('DD-MM-YYYY H:mm')+')'}}</td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <router-link :to="'/admin/shiftequipmentrequest/'+actualData.id+'/edit'" v-if="actualData.status==0" ><vue-feather type="edit-2"></vue-feather></router-link>
                                                            <router-link :to="'/admin/shiftequipmentrequest/'+actualData.id"><vue-feather type="eye"></vue-feather></router-link> 
