...
const getData = (page=1) => {
  axios.get(`/stockrequests/+${router.currentRoute.value.params.id}?page=${page}`,
      {
        params:{
...
<template>
    <div v-if="!loadingDiv">
        ...
        <h1 class="h3 mb-3">Requisições Stock</h1>
        
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Requisições Stock:</h5>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-xl-12 col-xxl-12 d-flex">
                                                <div class="w-100">
                                                    <h5 class="card-title">Informações da Requisição do Stock</h5>
