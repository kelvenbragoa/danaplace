...
const createRecordFunction = (values, actions) => {
    ...
    axios.post('/stockrequests',values).then((response)=>{
...
axios.get('/auxiliar-create-stockrequest')
     .then((response)=>{
...
<template>
    <div v-if="!loadingDiv">
        <h1 class="h3 mb-3">Requisição de Stock</h1>
        
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Formulário criação requisição de stock do sistema.</h5>
