...
const getData = async (page = 1) => {
  axios.get(`/logisticcustomer/+${router.currentRoute.value.params.id}?page=${page}`, 
  {
        params:{
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-xxl-12 d-flex">
                                                <div class="w-100">
                                                    <p>Nome: {{ retrievedData.customer_name }}</p>
                                                    <p>Email: {{ retrievedData.customer_email }}</p>
                                                    <p>Telefone: {{ retrievedData.customer_mobile }}</p>
                                                    <p>Endereço: {{ retrievedData.customer_address }}</p>
                                                    <p>NUIT: {{ retrievedData.customer_nuit }}</p>
