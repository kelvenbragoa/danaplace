...
const editFunction = (values, actions) => {
  ...
  axios.patch(`/causes/${retrievedData.value.id}`,values).then((response)=>{
    ...
    actions.resetForm();
    router.push({ path: '/admin/mcscr/causes' });
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <router-link to="/admin/mcscr/causes" class="btn btn-pill btn-primary mt-3"><vue-feather type="arrow-left"></vue-feather>Voltar</router-link> 
