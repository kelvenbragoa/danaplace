...
axios.delete(`/mcscr-resolution/${dataIdBeingDeleted}`)
.then(()=>{
 resolutions.value = resolutions.value.filter(data=>data.id !== dataIdBeingDeleted); 
...
const getData = () => {
  axios.get(`/mcscr/+${router.currentRoute.value.params.id}/edit`)
       .then((response)=>{
        ...
        reasonid.value = response.data.mcscr.reason_id ?? 0;
        causeid.value = response.data.mcscr.cause_id ?? 0;
        solutionid.value = response.data.mcscr.solution_id ?? 0;
        recommendationid.value = response.data.mcscr.recommendation_id ?? 0;
        consequenceid.value = response.data.mcscr.consequence_id ?? 0;
...
const editFunction = (values, actions) => {
  ...
  axios.patch(`/mcscr/${retrievedData.value.id}`,values).then((response)=>{
    ...
    actions.resetForm();
    router.go(-1);
    toastr.success('JobCard editado com sucesso');
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <router-link :to='"/admin/mcscr/"+retrievedData.id+"/upload"' class="btn btn-pill btn-primary mt-3 ml-2"><vue-feather type="file"></vue-feather>Ficheiros </router-link> 
                                                    ...
                                                    <Form @submit="editFunction" :validation-schema="schema" v-slot="{ errors }">
                                                        ...
                                                        <div class="card-body mb-5" style="background-color: rgb(232, 232, 232);">
                                                            <div class="row">
                                                                ...
                                                                <div class="mb-3 col-md-12">
                                                                    <!-- <Field as="textarea" class="form-control" :class="{'is-invalid':errors.reason}" name="reason" id="reason" placeholder="Motivo"/> -->
                                                                    <Field as="select" class="form-control" :class="{'is-invalid':errors.reason_id}"  name="reason_id" v-model="reasonid" id="reason_id" aria-describedby="reason_id">
                                                        ...
                                                        <div class="card-body mb-5" style="background-color: rgb(232, 232, 232);">
                                                            <div class="row">
                                                                ...
                                                                <div class="mb-3 col-md-12">
                                                                    <Field as="select" class="form-control" :class="{'is-invalid':errors.cause_id}"  name="cause_id" v-model="causeid" id="cause_id" aria-describedby="cause_id">
                                                                        <!-- <option value="" selected disabled>Selecionar</option> -->
                                                                        <option value="0" selected>Nenhum item</option>
                                                        ...
                                                        <div class="card-body mb-5" style="background-color: rgb(232, 232, 232);">
                                                            <div class="row">
                                                                ...
                                                                <div class="mb-3 col-md-12">
                                                                    ...
                                                                    <Field as="select" class="form-control" :class="{'is-invalid':errors.solution_id}"  name="solution_id" v-model="solutionid" id="solution_id" aria-describedby="solution_id">
                                                                        <!-- <option value="" selected disabled>Selecionar</option> -->
                                                                        <option value="0" selected>Nenhum item</option>
                                                        ...
                                                        <div class="card-body mb-5" style="background-color: rgb(232, 232, 232);">
                                                            <div class="row">
                                                                ...
                                                                <div class="mb-3 col-md-12">
                                                                    ...
                                                                    <Field as="select" class="form-control" :class="{'is-invalid':errors.consequence_id}"  name="consequence_id" v-model="consequenceid" id="consequence_id" aria-describedby="consequence_id">
                                                                        <option value="" selected disabled>Selecionar</option>
                                                                        <option value="0" selected>Nenhum item</option>
                                                        ...
                                                        <div class="card-body mb-5" style="background-color: rgb(232, 232, 232);">
                                                            <div class="row">
                                                                ...
                                                                <div class="mb-3 col-md-12">
                                                                    ...
                                                                    <Field as="select" class="form-control" :class="{'is-invalid':errors.recommendation_id}"  name="recommendation_id" v-model="recommendationid" id="recommendation_id" aria-describedby="recommendation_id">
                                                                        <option value="" selected disabled>Selecionar</option>
                                                                        <option value="0" selected>Nenhum item</option>
                                                        ...
                                                        <div class="row">
                                                            <label class="form-label" for="first_observation">Work Request:</label>
                                                                        ...
                                                                        <table class="table table-striped">
                                                                            ...
                                                                            <tbody>
                                                                                <tr v-for="(preresolution, index) in preresolutions" :key="preresolution.id">
                                                                                    <td>{{ index+1 }}</td>
                                                                                    <td>{{ preresolution.resolution_name }}</td>
                    
                                                                                    <td>
                                                                                        <a href="#" @click.prevent="confirmDeletion(preresolution)"><vue-feather type="trash"></vue-feather></a>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                        ...
                                                        <div class="row">
                                                            <label class="form-label" for="first_observation">Acções tomadas para resolução da avaria:</label>
                                                                ...
                                                                <fieldset class="InputGroup" v-for="(field, idx) in fields" :key="field.key">
                                                                        <div class="row">
                                                                            <div class="mb-9 col-md-9">
                                                                                <label class="form-label">Acção tomada:</label>
                                                                                <Field as="textarea" class="form-control" :class="{'is-invalid':errors.resolution_name}" :name="`mcscrs[${idx}].resolution_name`" id="resolution_name" placeholder="Descrição da acção tomada para resolução do problema"/>
                                                        ...
                                                        <div class="row">
                                                            <div class="mb-3 col-md-12">
                                                                ...
                                                                <Field as="select" class="form-control" v-model="loggedUser.id" :class="{'is-invalid':errors.user_id}" name="user_id" id="user_id" aria-describedby="user_id">
                                                        ...
                                                        <div class="row">
                                                            <div class="mb-3 col-md-12">
                                                                ...
                                                                <Field type="datetime-local" class="form-control" :class="{'is-invalid':errors.closed_at}" name="closed_at" id="closed_at" placeholder="Aberto às" required/>
                                                        ...
                                                        <hr>
                                                        <label class="form-label">Informação da viagem:</label>

                                                        <div class="row">
                                                            <div class="mb-3 col-md-12">
                                                                <label class="form-label" for="trip_start_date">Data Inicio:</label>
                                                                <Field type="date" class="form-control" :class="{'is-invalid':errors.trip_start_date}" v-model="retrievedData.trip_start_date" name="trip_start_date" id="trip_start_date" required/>
                                                                <span class="invalid-feedback">{{ errors.trip_start_date }}</span>
                                                            </div>
                                                        </div>

                                                        <div class="row">
                                                            <div class="mb-3 col-md-12">
                                                                <label class="form-label" for="trip_return_date">Data Retorno:</label>
                                                                <Field type="date" class="form-control" :class="{'is-invalid':errors.trip_return_date}" v-model="retrievedData.trip_return_date" name="trip_return_date" id="trip_return_date" required/>
                                                                <span class="invalid-feedback">{{ errors.trip_return_date }}</span>
                                                            </div>
                                                        </div>

                                                        <div class="row">
                                                            <div class="mb-3 col-md-12">
                                                                <label class="form-label" for="trip_travel_hours">Horas de Viagem:</label>
                                                                <Field type="number" class="form-control" :class="{'is-invalid':errors.trip_travel_hours}" v-model="retrievedData.trip_travel_hours" name="trip_travel_hours" id="trip_travel_hours" required/>
                                                                <span class="invalid-feedback">{{ errors.trip_travel_hours }}</span>
                                                            </div>
                                                        </div>

                                                        <div class="row">
                                                            <div class="mb-3 col-md-12">
                                                                <label class="form-label" for="trip_distance_traveled">Distância de Viagem:</label>
                                                                <Field type="number" class="form-control" :class="{'is-invalid':errors.trip_distance_traveled}" v-model="retrievedData.trip_distance_traveled" name="trip_distance_traveled" id="trip_distance_traveled" required/>
                                                                <span class="invalid-feedback">{{ errors.trip_distance_traveled }}</span>
                                                            </div>
                                                        </div>

                                                        <div class="row">
                                                            <div class="mb-3 col-md-12">
                                                                <label class="form-label" for="trip_travel_of">Origem:</label>
                                                                <Field type="text" class="form-control" :class="{'is-invalid':errors.trip_travel_of}" v-model="retrievedData.trip_travel_of" name="trip_travel_of" id="trip_travel_of" required/>
                                                                <span class="invalid-feedback">{{ errors.trip_travel_of }}</span>
                                                            </div>
                                                        </div>

                                                        <div class="row">
                                                            <div class="mb-3 col-md-12">
                                                                <label class="form-label" for="trip_travel_to">Destino:</label>
                                                                <Field type="text" class="form-control" :class="{'is-invalid':errors.trip_travel_to}" v-model="retrievedData.trip_travel_to" name="trip_travel_to" id="trip_travel_to" required/>
                                                                <span class="invalid-feedback">{{ errors.trip_travel_to }}</span>
                                                            </div>
                                                        </div>

                                                        <hr>

                                                        <label class="form-label">Informação do trabalho:</label>

                                                        <div class="row">
                                                            <div class="mb-3 col-md-12">
                                                                <label class="form-label" for="work_start_time">Hora Inicio:</label>
                                                                <Field type="time" class="form-control" :class="{'is-invalid':errors.work_start_time}" v-model="retrievedData.work_start_time" name="work_start_time" id="work_start_time" required/>
                                                                <span class="invalid-feedback">{{ errors.work_start_time }}</span>
                                                            </div>
                                                        </div>

                                                        <div class="row">
                                                            <div class="mb-3 col-md-12">
                                                                <label class="form-label" for="work_return_time">Hora Fim:</label>
                                                                <Field type="time" class="form-control" :class="{'is-invalid':errors.work_return_time}" v-model="retrievedData.work_return_time" name="work_return_time" id="work_return_time" required/>
                                                                <span class="invalid-feedback">{{ errors.work_return_time }}</span>
                                                            </div>
                                                        </div>

                                                        <div class="row">
                                                            <div class="mb-3 col-md-12">
                                                                <label class="form-label" for="work_total_amount_of_hours">Total Horas de Trabalho:</label>
                                                                <Field type="number" class="form-control" :class="{'is-invalid':errors.work_total_amount_of_hours}" v-model="retrievedData.work_total_amount_of_hours" name="work_total_amount_of_hours" id="work_total_amount_of_hours" required/>
                                                                <span class="invalid-feedback">{{ errors.work_total_amount_of_hours }}</span>
                                                            </div>
                                                        </div>

                                                        <div class="row">
                                                            <div class="mb-3 col-md-12">
                                                                <label class="form-label" for="work_nights_at_hotel">Noites no Hotel:</label>
                                                                <Field type="number" class="form-control" :class="{'is-invalid':errors.work_nights_at_hotel}" v-model="retrievedData.work_nights_at_hotel" name="work_nights_at_hotel" id="work_nights_at_hotel" required/>
                                                                <span class="invalid-feedback">{{ errors.work_nights_at_hotel }}</span>
                                                            </div>
                                                        </div>

                                                        <div class="row">
                                                            <div class="mb-3 col-md-12">
                                                                <label class="form-label" for="work_extra_start_times">Horas Inicio (Extra):</label>
                                                                <Field type="time" class="form-control" :class="{'is-invalid':errors.work_extra_start_times}" v-model="retrievedData.work_extra_start_times" name="work_extra_start_times" id="work_extra_start_times" required/>
                                                                <span class="invalid-feedback">{{ errors.work_extra_start_times }}</span>
                                                            </div>
                                                        </div>

                                                        <div class="row">
                                                            <div class="mb-3 col-md-12">
                                                                <label class="form-label" for="work_extra_ending_times">Horas Fim (Extra):</label>
                                                                <Field type="time" class="form-control" :class="{'is-invalid':errors.work_extra_ending_times}" v-model="retrievedData.work_extra_ending_times" name="work_extra_ending_times" id="work_extra_ending_times" required/>
                                                                <span class="invalid-feedback">{{ errors.work_extra_ending_times }}</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <FieldArray class="form-control" name="departments" v-slot="{ fields, push, remove }">
                                                                ...
                                                                <div class="card-body">
                                                                    <button type="button" class="btn btn-info mt-2" @click="push({ name: '' })">Adicionar Técnico +</button>
                                                                </div>
                                                            </FieldArray>
                                                        </div>
