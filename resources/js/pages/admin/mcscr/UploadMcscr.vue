...
const editFunction = (values, actions) => {
  ...
  values.mcscr_id = retrievedData.value.id;
  axios.post(`/mcscr/upload`,values,{
    headers: {
    ...
    uploads.value = response.data.uploads;
    actions.resetForm();
    router.push({ path: `/admin/mcscr/${retrievedData.value.id}/upload` });
    toastr.success('Job Card editado com sucesso');
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <router-link :to='"/admin/mcscr/"+retrievedData.id+"/edit"' class="btn btn-pill btn-primary mt-3"><vue-feather type="arrow-left"></vue-feather>Voltar</router-link> 
