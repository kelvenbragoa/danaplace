...
const getMcscrDestination = ()=>{

    console.log(destinationfilter.value)
...
<template>
    <div v-if="!loadingDiv">
        <h1 class="h3 mb-3">JobCards</h1>

                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Tabela dos JobCards do sistema. {{ retriviedData.total }} registros encontrados.</h5>
