...
const getData = async (page = 1) => {
    axios.get(`/contract-types?page=${page}`, {
...
const deleteData = () => {
    ...
    axios.delete(`/contract-types/${dataIdBeingDeleted}`)
        .then(() => {
...
<template>
    <div v-if="!loadingDiv">
        <h1 class="h3 mb-3">Tipos de Contrato</h1>

        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Tabela dos tipos de contrato. {{ retriviedData.total }} registros encontrados.</h5>
                        <h6 class="card-subtitle text-muted">Para procurar, digite na caixa de procura</h6>

                        <router-link to="/admin/contract-types/create" class="btn btn-pill btn-primary mt-3">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody v-if="retriviedData.data.length > 0">
                                    <tr v-for="(actualData, index) in retriviedData.data" :key="actualData.id">
                                        ...
                                        <td>{{ actualData.extra_fields?.length || 0 }}</td>
                                        <td>{{ actualData.technicians_count }}</td>
                                        <td>
                                            <router-link :to="'/admin/contract-types/' + actualData.id + '/edit'"><vue-feather type="edit-2"></vue-feather></router-link>
                                            <router-link :to="'/admin/contract-types/' + actualData.id"><vue-feather type="eye"></vue-feather></router-link>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Ao apagar este item, os técnicos associados ficarão sem tipo de contrato definido.
                    </div>
