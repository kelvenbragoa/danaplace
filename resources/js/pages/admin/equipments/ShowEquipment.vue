...
const selectedEnergyStatus = ref('total');
const totalEnergyCount = ref(0);

const selectedWaterStatus = ref('total');
const totalWaterCount = ref(0);
...
axios.post('/equipmentcomponent',values,{
    headers: {
...
const getData = (page=1) => {
  axios.get(`/equipments/+${router.currentRoute.value.params.id}?page=${page}`,
       ...
       .then((response)=>{
        ...
        totalWaterCount.value = response.data.totalWaterCount;
        totalEnergyCount.value = response.data.totalEnergyCount;
...
axios.get(`/equipments/+${router.currentRoute.value.params.id}/watercount`,{
params: {
date_range: selectedWaterStatus.value
}
})
.then((response)=>{
totalWaterCount.value = response.data.totalWaterCount;
...
axios.get(`/equipments/+${router.currentRoute.value.params.id}/energycount`,{
params: {
date_range: selectedEnergyStatus.value
}
})
.then((response)=>{
totalEnergyCount.value = response.data.totalEnergyCount;
                                                                ...
                                                                <Form @submit="createRecordFunction" :validation-schema="schema" v-slot="{ errors }">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="mb-3 col-md-6">
                                                                            ...
                                                                            <Field type="hidden" class="form-control" :class="{'is-invalid':errors.equipment_id}" name="equipment_id" id="equipment_id" v-model="retrievedData.id"/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="mb-3 col-md-6">
                                                        ...
                                                        <div class="col-sm-6 col-xl-2">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    ...
                                                                    <h1 class="mt-1 mb-3">{{ totalEnergyCount }}</h1>
                                                                    <div class="mb-0">
                                                                        <select name="date_range" @change="getEnergyCount()" v-model="selectedEnergyStatus" class="form-control">
                                                                            <option selected value="total" >Total</option>
                                                                            <option value="today" >Hoje</option>
                                                                            <option value="30" >30 dias</option>
                                                                            <option value="60" >60 dias</option>
                                                        ...
                                                        <div class="col-sm-6 col-xl-2">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    ...
                                                                    <h1 class="mt-1 mb-3">{{ totalWaterCount }} </h1>
                                                                    <div class="mb-0">
                                                                        <select name="date_range" @change="getWaterCount()" v-model="selectedWaterStatus" class="form-control">
                                                                            <option selected value="total" >Total</option>
                                                                            <option value="today" >Hoje</option>
                                                                            <option value="30" >30 dias</option>
                                                                            <option value="60" >60 dias</option>
...
<div class="col-12 col-lg-6">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">Consumo de Energia do Equipamento</h5>
            <h6 class="card-subtitle text-muted">Consumo de Energia por mês durante corrente ano.</h6>
        </div>
        <div class="card-body">
            <div class="chart">
                <Bar
...
<div class="col-12 col-lg-6">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">Consumo de Energia do Equipamento</h5>
            <h6 class="card-subtitle text-muted">Consumo de Energia por dia durante corrente mês do ano.</h6>
        </div>
        <div class="card-body">
            <div class="chart">
                <Bar
...
<div class="col-12 col-lg-6">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">Consumo de Água do Equipamento</h5>
            <h6 class="card-subtitle text-muted">Consumo de Água por mês durante corrente ano.</h6>
        </div>
        <div class="card-body">
            <div class="chart">
                <Bar
...
<div class="col-12 col-lg-6">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">Consumo de Água do Equipamento</h5>
            <h6 class="card-subtitle text-muted">Consumo de Água por dia durante corrente mês do ano.</h6>
        </div>
        <div class="card-body">
            <div class="chart">
                <Bar
