...
const createRecordFunction = (values, actions) => {
    ...
    axios.post('/toolrequests',values).then((response)=>{
...
axios.get('/auxiliar-create-toolrequest')
     .then((response)=>{
...
<template>
    <div v-if="!loadingDiv">
        <h1 class="h3 mb-3">Requisição de Ferramentaria</h1>
        
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Formulário criação requisição de Ferramentaria do sistema.</h5>
                                            ...
                                            <Form @submit="createRecordFunction" :validation-schema="schema" v-slot="{ errors }">
                                                ...
                                                <div class="row">
                                                    <FieldArray class="form-control" name="tools" v-slot="{ fields, push, remove }">
                                                                ...
                                                                <div class="row">
                                                                    <div class="mb-3 col-md-3">
                                                                        ...
                                                                        <Field as="select" class="form-control" :class="{'is-invalid':errors.tool_id}"  :name="`tools[${idx}].tool_id`" id="tool_id" aria-describedby="tool_id">
                                                                            ...
                                                                            <option v-for="tool in tools" :key="tool.id" :value="tool.id">{{ tool.name }} ({{ tool.code }})</option>
                                                                        </Field>
                                                                    ...
                                                                    <!-- <div class="mb-3 col-md-3">
                                                                        ...
                                                                        <Field type="number" class="form-control" :class="{'is-invalid':errors.quantity}" :name="`tools[${idx}].quantity`" id="quantity" placeholder="Quantidade"/>
                                                        ...
                                                        <div class="card-body">
                                                            <button type="button" class="btn btn-info mt-2" @click="push({ name: '' })">Adicionar Ferramenta +</button>
                                                        </div>
                                                    </FieldArray>
                                                </div>
												<div class="row">
