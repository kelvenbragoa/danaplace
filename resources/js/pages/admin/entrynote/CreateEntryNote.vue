...
const createRecordFunction = (values, actions) => {
    ...
    actions.resetForm();
    router.push({ path: '/admin/entrynotes' });
    toastr.success('Nota de Entrada criada com sucesso');
  }).catch((error)=>{
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Formulário criação dos Nota de Entrada do sistema.</h5>
