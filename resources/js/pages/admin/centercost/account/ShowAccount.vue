...
const getData = (page = 1) => {
  axios.get(`/centercostaccount/+${router.currentRoute.value.params.id}`, 
  {
        params:{
       ...
       .then((response)=>{
        ...
        retrievedData.value = response.data.account;
...
<template>
    <div v-if="!loadingDiv">
        ...
        <h1 class="h3 mb-3">Conta de centro de custo</h1>
        
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Conta: {{ retrievedData.name }}</h5>
                                        <h5 class="card-title">Centro de custo: {{ retrievedData.center_cost.name }}</h5>

                                        <router-link :to="'/admin/centercost/'+retrievedData.center_cost_id" class="btn btn-pill btn-primary mt-3"><vue-feather type="arrow-left"></vue-feather>Voltar</router-link> 
                                                ...
                                                <div class="w-100">
                                                    <div class="row">
                                                        <div class="col-sm-3">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <h5 class="card-title mb-4">Conta do centro de custo</h5>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <h5 class="card-title mb-4">Equipamentos/Ativos</h5>
