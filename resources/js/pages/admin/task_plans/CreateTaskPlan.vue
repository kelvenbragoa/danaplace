...
const createRecordFunction = (values, actions) => {
    ...
    axios.post('/taskplans',values).then((response)=>{

    // categories.value.unshift(response.data);
    // $('#createCategory').modal('hide');
    actions.resetForm();
    router.push({ path: '/admin/taskplans' });
    toastr.success('Plano de atividades criada com sucesso');
  }).catch((error)=>{
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Formulário criação dos planos de atividades do sistema.</h5>
