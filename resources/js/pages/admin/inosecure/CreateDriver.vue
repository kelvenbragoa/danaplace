...
const createRecordFunction = (values, actions) => {
    ...
    axios.post('/driver',values).then((response)=>{

    // categories.value.unshift(response.data);
    // $('#createCategory').modal('hide');
    actions.resetForm();
    router.push({ path: '/admin/driver' });
    toastr.success('Motorista criada com sucesso');
  }).catch((error)=>{
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Formulário criação das Motorista do sistema.</h5>
                                            ...
                                            <Form @submit="createRecordFunction" :validation-schema="schema" v-slot="{ errors }">
                                                ...
                                                <div class="row">
													<div class="mb-3 col-md-12">
														...
														<Field type="text" class="form-control" :class="{'is-invalid':errors.license}" name="license" id="license" placeholder="Descrição"/>
