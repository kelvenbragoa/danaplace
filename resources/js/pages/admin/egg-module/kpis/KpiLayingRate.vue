...
const loadData = () => {
    ...
    axios.get('/admin/egg-kpis/laying-rate', {
        params: {
...
<template>
    <div v-if="!loadingDiv">
        <h1 class="h3 mb-3">KPIs de Postura</h1>
        ...
        <div class="row mb-4">
            <div class="col-md-4 mb-3">
                <div class="card border-primary h-100"><div class="card-body">
                    <h6 class="text-primary">Taxa Média</h6>
                    <h3>{{ summary.average_rate ?? 0 }}%</h3>
                </div></div>
            </div>
            <div class="col-md-4 mb-3">
                <div class="card border-success h-100"><div class="card-body">
                    <h6 class="text-success">Máxima</h6>
                    <h3>{{ summary.max_rate ?? 0 }}%</h3>
                </div></div>
            </div>
            <div class="col-md-4 mb-3">
                <div class="card border-danger h-100"><div class="card-body">
                    <h6 class="text-danger">Mínima</h6>
                    <h3>{{ summary.min_rate ?? 0 }}%</h3>
                </div></div>
            </div>
        </div>
