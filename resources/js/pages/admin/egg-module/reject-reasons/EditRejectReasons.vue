...
const editFunction = (values, actions) => {
    ...
    axios.patch(`/admin/reject-reasons/${retrievedData.value.id}`, payload).then(() => {
        router.push({ path: '/admin/motivos-refugo' });
        toastr.success('Motivo editado com sucesso');
    }).catch((error) => {
                        ...
                        <Form @submit="editFunction" :validation-schema="schema" v-slot="{ errors }">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-12">
                                    ...
                                    <Field as="textarea" class="form-control" :class="{'is-invalid': errors.description}" name="description" v-model="retrievedData.description" id="description" rows="3"/>
