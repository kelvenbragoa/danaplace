...
const getData = (page=1) => {
  axios.get(`/categories/+${router.currentRoute.value.params.id}?page=${page}`,
      {
        params:{
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <router-link to="/admin/categories" class="btn btn-pill btn-primary mt-3"><vue-feather type="arrow-left"></vue-feather>Voltar</router-link> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-xxl-12 d-flex">
                                                <div class="w-100">
                                                    <p>Nome da Categoria: {{ retrievedData.name }}</p>
