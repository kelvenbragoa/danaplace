...
const getData = (page=1) => {
  axios.get(`/inventories/+${router.currentRoute.value.params.id}?page=${page}`,
      {
        params:{
       ...
       .then((response)=>{
        ...
        retrievedData.value = response.data.inventory;
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-xxl-12 d-flex">
                                                <div class="w-100">
                                                    ...
                                                    <p>Produtos Inventariados: {{ retrievedData.products_number }}</p>
