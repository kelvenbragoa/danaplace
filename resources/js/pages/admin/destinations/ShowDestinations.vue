                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-xxl-12 d-flex">
                                                <div class="w-100">
                                                    <p>Proprietário: {{ retrievedData.name }}</p>
                                                        ...
                                                        <table class="table table-striped">
                                                            ...
                                                            <tbody>
                                                                <tr  v-for="(actualData,index) in typeequipments" :key="actualData.id">
                                                                    ...
                                                                    <td>
                                                                        <router-link :to="'/admin/destinations/'+retrievedData.id+'/fleet/'+actualData[0].type_equipment_id"><vue-feather type="eye"></vue-feather></router-link>                                                                         
                                                                    </td>
                                                                    <!-- <td>
                                                                        {{ 
                                                                    ...
                                                                    <td>
                                                                        <router-link :to="'/admin/typeequipments/'+actualData.id+'/edit'"><vue-feather type="edit-2"></vue-feather></router-link>
                                                                        <router-link :to="'/admin/typeequipments/'+actualData.id"><vue-feather type="eye"></vue-feather></router-link> 
                                                    ...
                                                    <form class="d-none d-sm-inline-block mt-3">
                                                        <div class="input-group input-group-navbar">
                                                            <input type="text" class="form-control" v-model="searchQuery" placeholder="Procurar equipamento..." aria-label="Search">
                                                        </div>
                                                    </form>
                                                            ...
                                                            <tbody v-if="equipments.data.length > 0">
                                                                <tr  v-for="(actualData,index) in equipments.data" :key="actualData.id">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <router-link :to="'/admin/equipments/'+actualData.id+'/file'"><vue-feather type="file"></vue-feather></router-link> 
