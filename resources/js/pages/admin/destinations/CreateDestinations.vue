...
const createRecordFunction = (values, actions) => {
    ...
    axios.post('/destinations',values,{
            headers: {
    ...
    toastr.success('Clientes criado com sucesso');
  }).catch((error)=>{
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Formulário criação das áreas do sistema.</h5>
                                            ...
                                            <Form @submit="createRecordFunction" :validation-schema="schema" v-slot="{ errors }">
                                                ...
                                                <div class="row">
													<div class="mb-3 col-md-12">
														...
														<Field as="select" class="form-control" :class="{'is-invalid':errors.is_logistic}"  name="is_logistic" id="is_logistic" aria-describedby="is_logistic">
