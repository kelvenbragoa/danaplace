...
const createRecordFunction = (values, actions) => {
    ...
    axios.post('/schedulework',values).then((response)=>{

    // categories.value.unshift(response.data);
    // $('#createCategory').modal('hide');
    actions.resetForm();
    router.push({ path: '/admin/schedulework' });
    toastr.success('Escala de Trabalho criada com sucesso');
  }).catch((error)=>{
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Formulário criação das escalas de trabalho do sistema.</h5>
                                            ...
                                            <Form @submit="createRecordFunction" :validation-schema="schema" v-slot="{ errors }">
                                                ...
                                                <div class="row">
													<div class="mb-3 col-md-12">
														...
														<Field type="date" class="form-control" :class="{'is-invalid':errors.date}" name="date" id="date" placeholder="Nome"/>
                                                ...
                                                <div class="row">
													<div class="mb-3 col-md-12">
														...
														<Field type="text" class="form-control" :class="{'is-invalid':errors.responsible}" name="responsible" id="responsible" placeholder="Responsável"/>
                                                        <span class="invalid-feedback">{{ errors.responsible }}</span>
													</div>
												</div>
