...
const getData = () => {
  axios.get(`/schedulework/+${router.currentRoute.value.params.id}/edit`)
       .then((response)=>{
...
const editFunction = (values, actions) => {
  ...
  axios.patch(`/schedulework/${retrievedData.value.id}`,values).then((response)=>{
                                                    ...
                                                    <Form @submit="editFunction" :validation-schema="schema" v-slot="{ errors }">
                                                        ...
                                                        <div class="row">
                                                            <div class="mb-3 col-md-12">
                                                                ...
                                                                <Field type="text" class="form-control" :class="{'is-invalid':errors.responsible}" name="responsible" v-model="retrievedData.responsible" id="responsible" placeholder="Responsável"/>
