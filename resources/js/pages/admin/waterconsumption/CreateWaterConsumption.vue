...
const createRecordFunction = (values, actions) => {
    ...
    axios.post('/waterconsumption',values).then((response)=>{
...
<template>
    <div v-if="!loadingDiv">
        <h1 class="h3 mb-3">Consumo de Água</h1>
        
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Formulário criação Consumo de Água do sistema.</h5>
