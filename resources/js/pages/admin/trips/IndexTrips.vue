...
axios.delete(`/trips/${dataIdBeingDeleted}`)
.then(()=>{
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <router-link to="/admin/trips/create" class="btn btn-pill btn-primary mt-3"><vue-feather type="plus"></vue-feather>Adicionar</router-link> 
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody v-if="retriviedData.data.length > 0">
                                                    <tr  v-for="(actualData,index) in retriviedData.data" :key="actualData.id">
                                                        ...
                                                        <td>{{ moment(actualData.departure_date).format('DD-MM-YYYY')}}</td>
                                                        <td>{{ moment(actualData.return_date).format('DD-MM-YYYY')}}</td>
                                                        <td>{{ actualData.total_expenses}} MT</td>
                                                        <td>
                                                            <router-link :to="'/admin/trips/'+actualData.id+'/edit'"><vue-feather type="edit-2"></vue-feather></router-link>
                                                            <router-link :to="'/admin/trips/'+actualData.id"><vue-feather type="eye"></vue-feather></router-link> 
