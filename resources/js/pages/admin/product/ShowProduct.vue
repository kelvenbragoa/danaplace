...
const getData = (page=1) => {
  axios.get(`/products/+${router.currentRoute.value.params.id}?page=${page}`,
      {
        params:{
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Fabricantes/Fornecedores: {{ retrievedData.name }}</h5>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-xxl-12 d-flex">
                                                <div class="w-100">
                                                    ...
                                                    <p> <strong>Código:</strong> {{ retrievedData.name }}</p>
                                                    <p> <strong>Marca:</strong> {{ retrievedData.brand.name }}</p>
                                                    <p> <strong>Categoria:</strong> {{ retrievedData.category.name }}</p>
                                                    <p> <strong>Preço Unitário de Compra:</strong> {{ retrievedData.unity_buy_price }} MT</p>
                                                    <p> <strong>Preço Unitário de Venda:</strong> {{ retrievedData.unity_price }} MT</p>
                                                    <p> <strong>Taxa de IVA:</strong> {{ retrievedData.iva.name }}</p>
                                                    <p> <strong>Stock:</strong> {{ retrievedData.quantity }}</p>
